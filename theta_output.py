...
Y = df.drop(columns=['strike', 'underlying', 'maturity', 'volatility', 'interestrate', 'call_price','delta','vega','rho'])
...
plt.xlabel('pred theta')
plt.ylabel('actual theta')
plt.savefig('theta_output/final_test_price' + '.png', bbox_inches="tight")
plt.clf()
